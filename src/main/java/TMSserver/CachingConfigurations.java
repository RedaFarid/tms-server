...
//    @Primary
    public CacheManager cacheManager() {
        return new ConcurrentMapCacheManager("tanks","materials","drivers","clients","truckTrailers","truckContainers","stations","transactions","computers","users","roles","roleRef");
    }
